...
<div>
    ...
    <div>
    <a class="btn btn-primary btn-lg" href="setup_preferences2.php"> Previous Page </a>
    <a class="btn btn-primary btn-lg" href="setup_preferences_done.php"> Finish Quiz </a>
    </div>
</div>